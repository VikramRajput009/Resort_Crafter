        ...
        if(ae.getSource() == check){
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    tfcheckin.setText(rs.getString("chechintime"));
            ...
            try{
                ...
                c.s.executeUpdate("update customer set room = '"+ room +"', name = '"+ name +"', chechintime = '"+ checkin +"', deposit = '"+ deposit +"' where number = '"+ number +"'");
